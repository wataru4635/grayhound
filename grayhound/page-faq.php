            ...
            <div class="faq__item-inner">
              ...
              <div class="faq__item-answer">
                <div class="faq__item-answer-inner">
                  <span class="faq__item-a-label">A</span>
                  <p class="faq__item-a-text">
                    当校のレッスンでは、英語の発音をとても大切にしています。<br class="u-desktop">そのため、日本語にはない「f」や「th」の発音が身につきやすい小学生4年生までのお子様が入学対象となっています。
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="faq__item-inner">
              ...
              <div class="faq__item-answer">
                <div class="faq__item-answer-inner">
                  <span class="faq__item-a-label">A</span>
                  <p class="faq__item-a-text">
                    せっかく習いに来ているのに、小さな声でボソボソ練習しても、上手になりません。<br class="u-desktop">レッスンでは、大きな声で正しい発音で会話ができるまで何度でも練習します。<br class="u-desktop">ですから、子供英会話スクールによく見られるような外国人講師とただ遊んでいる…という甘いレッスンではありません。<br class="u-desktop">厳しいけれど楽しい当校のレッスンスタイルは1975年の創立以来変わっていません。<br class="u-desktop">子供たちはレッスンの中で「話せた！」という喜びを感じることができるので、教室はいつも笑い声でいっぱいです。
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="faq__item-inner">
              ...
              <div class="faq__item-answer">
                <div class="faq__item-answer-inner">
                  <span class="faq__item-a-label">A</span>
                  <p class="faq__item-a-text">
                    当校は、塾ではなく英会話スクールですので、「話す」ことを最優先にしています。<br class="u-desktop">したがって、レベル3になるまでは、書くことはしません。せっかく小さい頃から始めるのに、<br class="u-desktop">中学文法の先取りをするのではなく、英語をたくさん聞いて、たくさん話してほしいと考えています。<br>英検に関しても、小学校低学年での5級〜3級の先取り合格を目標にするのではなく、<br class="u-desktop">中学校以降の準2級〜準1級の受験時に有利になるような力をつけていきます。
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="faq__item-inner">
              ...
              <div class="faq__item-answer">
                <div class="faq__item-answer-inner">
                  <span class="faq__item-a-label">A</span>
                  <p class="faq__item-a-text">
                    「経験がある」場合でも、英語の力は個々によって異なります。<br class="u-desktop">無料体験中に英語の力を見させて頂きますので、まずは、レベル1のクラスから受講してください。<br class="u-desktop">力があると判断した場合は進級しますが、進級のスピードにこだわるよりも、<br class="u-desktop">それぞれのクラスでのカリキュラムを着実に習得する事を一番にお考えください。
                  </p>
                </div>
              </div>
            </div>
